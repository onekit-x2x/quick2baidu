...
Page({
 ...
 this.ssss =swan.getFileSystemManager()
    file.move({
      ...
      fail: function(data, code) {
        console.log(`handling fail move`, data, code)
      }
    })
    ...
    file.copy({
      ...
      fail: function(data, code) {
        console.log(`handling fail copy`,data,code)
      }
    })
    ...
    file.list({
      ...
      fail: function(data, code) {
        console.log(`handling fail list`, data, code)
      }
    })
    ...
    file.get({
      ...
      fail: function(data, code) {
        console.log(`handling fail get`,data,code)
      }
    })
